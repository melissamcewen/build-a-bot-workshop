...
![alt text](assets/images/tokengen.jpg "generate your token")
Great, now let's head to Glitch and copy it in
![alt text](assets/images/glitch-env-vars.jpg "your Env vars")
...
![alt text](assets/images/pagesubscription.jpg "connecting the Webhook to glitch.")
